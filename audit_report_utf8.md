...
<site url="http://localhost:3000" crawled="16" date="2026-02-15T04:32:22.943Z"/>
<score overall="38" grade="F">
 <cat name="Security" score="52"/>
 ...
 <cat name="Content" score="69"/>
 <cat name="URL Structure" score="90"/>
...
<summary passed="1069" warnings="288" failed="35"/>
<issues>
 <category name="Crawlability" errors="1" warnings="3">
  ...
  <rule id="crawl/sitemap-coverage" severity="warning" status="warn" docs="https://docs.squirrelscan.com/rules/crawl/sitemap-coverage">
   16 indexable page(s) not in sitemap (100%); 616 sitemap URL(s) were not crawled
   Items (5/632):
    - /
    - /audit/1756-IA8D
    - /audit/1756
 ...
 <category name="Core SEO" errors="0" warnings="97">
  <rule id="core/meta-description" severity="error" status="warn" docs="https://docs.squirrelscan.com/rules/core/meta-description">
   ...
   Pages (5/16): /, /audit/1756, /audit/1756-IA16, /audit/1756-IA16I, /audit/1756-IA32
   Items (5/16):
    - / (Critical risk assessment and real-time inventory f (105 chars))
    - /audit/1756-IA8D (Critical risk assessment and real-time inventory f (105 chars))
    - /audit/1756 (Critical risk assessment and real-time inventory f (105 chars))
    - /audit/1756-IA16 (Critical risk assessment and real-time inventory f (105 chars))
    - /audit/1756-IA16I (Critical risk assessment and real-time inventory f (105 chars))
  </rule>
  ...
  <rule id="core/title-unique" severity="warning" status="warn" docs="https://docs.squirrelscan.com/rules/core/title-unique">
   1 duplicate title(s) affecting 16 pages
   Items (1):
    - machine audit | industrial ghost parts (&quot;machine audit | industrial ghost parts...&quot; (16 pages)) [pageCount: 16] (from: /, /audit/1756-IA8D, /audit/1756, /audit/1756-IA16, /audit/1756-IA16I; +11 more)
  </rule>
 ...
 <category name="Security" errors="16" warnings="2">
 ...
 <category name="Content" errors="0" warnings="34">
  <rule id="content/duplicate-title" severity="warning" status="warn" docs="https://docs.squirrelscan.com/rules/content/duplicate-title">
   1 duplicate title(s) found across 16 pages
   Items (1):
    - machine audit | industrial ghost parts (&quot;machine audit | industrial ghost parts...&quot; (16 pages)) [pageCount: 16] (from: /, /audit/1756-IA8D, /audit/1756, /audit/1756-IA16, /audit/1756-IA16I; +11 more)
  </rule>
  <rule id="content/duplicate-description" severity="warning" status="warn" docs="https://docs.squirrelscan.com/rules/content/duplicate-description">
   1 duplicate description(s) found across 16 pages
   Items (1):
    - critical risk assessment and real-time inventory for discont (&quot;critical risk assessment and real-time i...&quot; (16 pages)) [pageCount: 16] (from: /, /audit/1756-IA8D, /audit/1756, /audit/1756-IA16, /audit/1756-IA16I; +11 more)
  </rule>
  ...
  <rule id="content/keyword-stuffing" severity="warning" status="warn" docs="https://docs.squirrelscan.com/rules/content/keyword-stuffing">
   4 word(s) may be overused
   Pages (1): /
   Items (4):
    - auditcritical (&quot;auditcritical&quot; (8.2%)) [count: 14, density: 8.235294117647058]
    - bradley (&quot;bradley&quot; (8.2%)) [count: 14, density: 8.235294117647058]
    - controllogixcontrollogixenter (&quot;controllogixcontrollogixenter&quot; (8.2%)) [count: 14, density: 8.235294117647058]
    - allen (&quot;allen&quot; (4.1%)) [count: 7, density: 4.117647058823529]
  </rule>
  <rule id="content/word-count" severity="warning" status="warn" docs="https://docs.squirrelscan.com/rules/content/word-count">
   ...
   Pages (5/16): /, /audit/1756, /audit/1756-IA16, /audit/1756-IA16I, /audit/1756-IA32
   Items (5/16):
    - / (Thin content: 148 words (min 300))
    - /audit/1756-IA8D (Thin content: 136 words (min 300))
    - /audit/1756 (Thin content: 135 words (min 300))
    - /audit/1756-IA16 (Thin content: 136 words (min 300))
    - /audit/1756-IA16I (Thin content: 136 words (min 300))
  </rule>
 </category>
 ...
 <category name="Performance" errors="2" warnings="98">
  <rule id="perf/js-file-size" severity="error" status="warn" docs="https://docs.squirrelscan.com/rules/perf/js-file-size">
   ...
   Items (3):
    - /_next/static/chunks/9ace1_next_dist_compiled_react-dom_1ea6f237._.js [sizeBytes: 1048258, size: 1023.7 KB, status: 200, contentType: application/javascript; charset=UTF-8] (from: /, /audit/1756-IA8D, /audit/1756, /audit/1756-IA16, /audit/1756-IA16I; +11 more)
    - /_next/static/chunks/9ace1_next_dist_compiled_next-devtools_index_71297dc5.js [sizeBytes: 816054, size: 796.9 KB, status: 200, contentType: application/javascript; charset=UTF-8] (from: /, /audit/1756-IA8D, /audit/1756, /audit/1756-IA16, /audit/1756-IA16I; +11 more)
    - /_next/static/chunks/9ace1_next_dist_client_5a3ef046._.js [sizeBytes: 629427, size: 614.7 KB, status: 200, contentType: application/javascript; charset=UTF-8] (from: /, /audit/1756-IA8D, /audit/1756, /audit/1756-IA16, /audit/1756-IA16I; +11 more)
  </rule>
  <rule id="perf/ttfb" severity="warning" status="fail" docs="https://docs.squirrelscan.com/rules/perf/ttfb">
   Very slow server response (Nms)
   Pages (2): /audit/1756, /audit/1756-IA8D
   Items (2):
    - /audit/1756-IA8D (Very slow server response (5449ms))
    - /audit/1756 (Very slow server response (5456ms))
  </rule>
  <rule id="perf/total-byte-weight" severity="warning" status="warn" docs="https://docs.squirrelscan.com/rules/perf/total-byte-weight">
   Total tracked resources: 3210KB (heavy page)
  </rule>
  ...
  <rule id="perf/http2" severity="info" status="warn" docs="https://docs.squirrelscan.com/rules/perf/http2">
   ...
   Items (5/16):
    - / (HTTP/2 requires HTTPS)
    - /audit/1756-IA8D (HTTP/2 requires HTTPS)
    - /audit/1756 (HTTP/2 requires HTTPS)
    - /audit/1756-IA16 (HTTP/2 requires HTTPS)
    - /audit/1756-IA16I (HTTP/2 requires HTTPS)
  </rule>
 ...
 <category name="Accessibility" errors="1" warnings="33">
